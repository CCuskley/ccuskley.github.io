...
function setParams() {
  ...
  $("#frameSec").text(interRate.toString())
  $("#popSize").text(N.toString())
  $("#vocSize").text(L.toString())
}
...
$(document).ready(function() {
  ...
  $("#numMeanings").on('change',function() {
    resetSim()
  });

  $("#rateSlider").on('change',function() {
    console.log("bfore:", interRate)
    interRate=parseInt($(this).val())
    frameRate(interRate)
    console.log("after",interRate)
    $("#frameSec").text(interRate.toString())
  });

  $("#numAgents").on('change',function() {
    resetSim()
  });
