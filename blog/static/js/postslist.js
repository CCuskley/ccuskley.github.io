var posts = [
	...
	{	
		...
		"fpSnippet":'<p>I spent the better part of my carreer teaching programming, data analysis, and experimental methods in the UK. This is not something my students are necessarily expecting - many of them abandoned "hard" STEM subjects like mathematics and computing at the first opportunity, probably in their early teens. Their expectations and perceptions about these topics - which all build on basic digital literacy - are both surprising, and revealing.</p><p>Once, a student was nearly in tears and informed me "they did not study English to do maths". Over the years, multiple students have asked if they need to “know how to use a computer”. When I tell students they will need to use a desktop computer to complete their assignments (i.e., you can\'t do it on a tablet, and definitely not on a phone), I often get dismissive eyerolls.</p>'
		},
		{
			"date":"April 4, 2025",
